...
2. **`outputs/flickr8k_sgd/best_model_flickr8k_continued.pt`** (286 MB) ⭐
   - **Overall best (epoch 46)**
   - **R@1: 0.36%**
   - **Use this one!**

3. **`outputs/flickr8k_sgd/latest_model_flickr8k.pt`** (286 MB)
...
### Results & History
6. **`outputs/flickr8k_sgd/history_flickr8k.json`**
   - Original 30 epochs metrics

7. **`outputs/flickr8k_sgd/history_flickr8k_continued.json`**
   - Full 80 epochs metrics

8. **`outputs/flickr8k_sgd/test_results_continued.json`**
   - Test set evaluation
