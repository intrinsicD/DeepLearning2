...
# Done! Model saved to results/folder_per_model/multimodal_memory/outputs/best_multimodal_model.pt
```
...
python continue_training_flickr8k.py \
    --checkpoint results/folder_per_model/multimodal_memory/outputs/best_model.pt --epochs 20
```
...
4. **modules/nl_mm/README.md** - Architecture details
