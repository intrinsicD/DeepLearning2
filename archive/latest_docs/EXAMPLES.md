...
from utils import Trainer, get_mnist_loaders, get_device
...
```python
from modules.experiments import compare_architectures
...
```python
from modules.experiments import compare_optimizers
...
python -m modules.experiments.mnist_example --arch cnn --optimizer adam --epochs 5

# Compare different architectures
python -m modules.experiments.compare_architectures --epochs 3

# Compare different optimizers
python -m modules.experiments.compare_optimizers --epochs 5
