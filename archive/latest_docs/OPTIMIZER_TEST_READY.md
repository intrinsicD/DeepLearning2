...
`results/folder_per_model/nl_mm/outputs/optimizer_comparison/optimizer_comparison.png`
...
`results/folder_per_model/nl_mm/outputs/optimizer_comparison/optimizer_comparison.json`
...
python test_nl_mm_optimizers.py --lr 1e-4 --output_dir results/folder_per_model/nl_mm/outputs/lr_1e4
python test_nl_mm_optimizers.py --lr 1e-3 --output_dir results/folder_per_model/nl_mm/outputs/lr_1e3
python test_nl_mm_optimizers.py --lr 1e-2 --output_dir results/folder_per_model/nl_mm/outputs/lr_1e2
```
...
```bash
--config modules/nl_mm/configs/tiny_single_gpu.yaml  # Larger model
```
