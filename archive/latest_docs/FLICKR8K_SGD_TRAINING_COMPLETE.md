...
### ✅ Model Saved
- **Location:** `results/folder_per_model/multimodal_memory/outputs/flickr8k_sgd/best_model_flickr8k.pt`
- **Size:** 286 MB
- **Best epoch:** 18
...
2. **`results/folder_per_model/multimodal_memory/outputs/flickr8k_sgd/history_flickr8k.json`**
