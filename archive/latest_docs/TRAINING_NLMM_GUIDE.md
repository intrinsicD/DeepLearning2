...
Edit `modules/nl_mm/configs/flickr8k.yaml`:
...
2. **Export for inference**
   ```bash
   python modules/nl_mm/export.py --config modules/nl_mm/configs/flickr8k.yaml --output model.pt
   ```
...
1. ✅ Dataset loader: `utils/flickr8k_dataset.py`
2. ✅ Training scripts: `train_flickr8k.py`, `train_flickr8k_improved.py`
3. ✅ Model architecture: `modules/nl_mm/models/nl_mm_model.py`
