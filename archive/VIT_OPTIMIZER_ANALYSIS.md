...
1. `/src/optimizers/muon_fast.py` - Added dimension-aware scaling in `_compute_update_scale()`
2. `/src/experiments/vit_optimizer_experiment.py` - Updated MuonFast (lr=0.0003) and AndersonGDA (lr=0.01, beta=0, m=2) configs
