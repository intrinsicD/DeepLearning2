...
from architectures import FullyConnectedNet, ResNet, SimpleCNN
from modules.experiments.compare_architectures import compare_architectures
from modules.experiments.compare_optimizers import compare_optimizers
from optimizers import AndersonGDA, CustomAdam, CustomSGD, GDA2, MuonFast
from utils import Trainer, get_device, print_gpu_info
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-root",
        type=Path,
        default=Path("results") / "folder_per_model" / "multimodal_memory" / "reports" / "quick_start",
...
def main(args: argparse.Namespace | None = None) -> None:
    ...
    if args.skip_extensive:
        ...
        print("2. Explore python -m modules.experiments.compare_architectures for custom comparisons.")
        print("3. Explore python -m modules.experiments.compare_optimizers for optimizer studies.")
    else:
        print(
        ...
        print("architectures/ and optimizers/ for your own experiments.")
    print("=" * 60)
