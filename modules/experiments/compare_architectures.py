...
from architectures import SimpleCNN, ResNet, FullyConnectedNet
...
def compare_architectures(
    ...
    Args:
        ...
        output_dir: Optional directory in which to save visual summaries. When
            ``None`` (default), figures are stored in ``results/figures/experiments/architecture_comparison``.
    ...
    if output_dir is None:
        output_dir = Path("results") / "figures" / "experiments" / "architecture_comparison"
    else:
