...
📊 Saved plot to outputs/optimizer_comparison/optimizer_comparison.png
```
...
# Check imports
python3 -c "from src.optimizers.universal_optimizers import UniversalMuon"
python3 -c "from nl_mm.modules.optim.d_mgd import DMGD"
```
