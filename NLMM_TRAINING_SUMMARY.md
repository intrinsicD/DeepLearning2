...
Location: `outputs/nlmm_flickr8k/training_progress.png`
...
Edit `nl_mm/configs/tiny_single_gpu.yaml` if needed:
...
# Check data loading
python -c "from src.utils.flickr8k_dataset import Flickr8kAudioDataset; ds = Flickr8kAudioDataset('flickr8k', 'train'); print(len(ds))"
...
### Dataset Loaders
- ✅ `src/utils/flickr8k_dataset.py` - Flickr8k + FACC loader
- ✅ `src/utils/flickr8k_improved.py` - With better augmentation
- ✅ `src/utils/flickr8k_simple.py` - Simplified version

### Model Architecture
- ✅ `nl_mm/models/nl_mm_model.py` - Core NL-MM model
- ✅ `src/architectures/multimodal_memory.py` - Wrapper architecture
